...
class Users(db.Model):
    ...
    role = db.Column(db.Enum("admin", "user", name="role"), unique=False, nullable=False)
...
class Trips(db.Model):
    ...
    user_to = db.relationship("Users", foreign_keys=[user_id], backref=db.backref("trips", lazy="select"))
...
class UserTrips(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'))
    user_to = db.relationship("Users", foreign_keys=[user_id], backref=db.backref("user_trips", lazy="select"))
    trip_id = db.Column(db.Integer, db.ForeignKey('trips.id'), nullable=False)
    trip_to = db.relationship("Trips", foreign_keys=[trip_id], backref=db.backref("user_trips", lazy="select"))
