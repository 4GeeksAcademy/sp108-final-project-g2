  ...
  return (
    <div className="container py-5">
      ...
      <div className="text-center mb-4">
        ...
        <small className="text-muted d-block mb-3">Del {trip.start_date} al {trip.end_date}</small>
      ...
      <div className="row mt-4">
        <div className="col-6">
          {activities.length > 0 ?
            <h4 className="mb-3 ms-2">{activities.length > 1 ? `Actividades | ${activities.length}` : `Actividad | ${activities.length}`}</h4>
            :
            <h4 className="d-none"></h4>
          }
          {activities.length > 0 ?
                ...
                >
                  ...
                  <div className="row mb-3">
                    <div className="col-auto">
                      <span className="me-3"><i class="fa-solid fa-calendar-days me-2"></i>{activity.date}</span>
                      <span><i class="fa-solid fa-clock me-2"></i>{activity.time}</span>
                    </div>
                  </div>
